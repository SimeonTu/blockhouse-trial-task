...
from .views import candlestick_data, line_chart_data, bar_chart_data, pie_chart_data, pizza_pie_chart_data
...
urlpatterns = [
    ...
    path('pizza-pie-chart-data/', pizza_pie_chart_data, name='pizza_pie-chart-data'),
]